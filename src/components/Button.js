...
function Button() {
  ...
  const [formats, setFormats] = useState([])
    ...
    const activeButtonStyle = {
      textTransform: 'capitalize',background : 'white', border: '1px solid #460AF0', color:'#460AF0', display:"flex" ,alignItems:"center",justifyContent:"center",padding:"10px",width:"109px",height:"30px",borderRadius:"2px",fontSize:"12px",lineHeight:"18px",fontWeight:"500",
    ...
    const groupButton = {display:"flex", flexWrap:"wrap", alignItems:"center",justifyContent:"center",gap:"12px"}
  ...
  return (
    <div style={{display:"flex", flexWrap:"wrap", alignItems:"center",justifyContent:"center",gap:"12px", padding:"20px 50px"}}>
